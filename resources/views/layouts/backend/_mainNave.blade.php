        ...
        <ul>
            <li class="has-sub-menu"><a href="#"><i class="zmdi zmdi-accounts-add zmdi-hc-fw"></i> <span>Registration</span></a>
                <ul class="side-header-sub-menu">
                    <li><a href="#"><i class="zmdi zmdi-account-box zmdi-hc-fw"></i><span>Doctors</span></a></li>
            ...
            <li class="has-sub-menu"><a href="#"><i class="zmdi zmdi-accounts-alt zmdi-hc-fw"></i> <span>Account</span></a>
                <ul class="side-header-sub-menu">
                    <li><a href="#"><i class="fa fa-sign-in" aria-hidden="true"></i><span>Signin</span></a></li>
                    <li><a href="#"><i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i><span>Forgot Password</span></a></li>
                </ul>
            </li>
